...
Submissions.prototype.insert = function (submissionObj, callback) {
  this.collection.insert(submissionObj, callback);
}

Submissions.prototype.changeScore = function(id, newScore, callback) {
  var query = {
    '_id': new ObjectID(id)
  };
...
Submissions.prototype.removeUserSubmissions = function (userId, callback) {
  var query = {
    'User': new ObjectID(userId)
  };
