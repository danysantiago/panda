...
Projects.prototype = {
    ...
    "populate": function(params, callback) {
        ...
        exec(__dirname + '/../createRepo.sh ' + params.name.toLowerCase() + ' nelii28o2 mofongo ' + params.username + ' ' + params.archive, function (error, stdout, stderr) {
            if(self.logFunc && typeof self.logFunc === "function") {
                self.logFunc(stdout);
                self.logFunc(stderr);
            }
