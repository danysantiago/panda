...
Repositories.prototype = {
     ...
     *
     * @param params
     * @param params.id id of a project (required)
     * @param params.sha the commit sha to download (optional, defaults to tip of default branch)
     */
     ...
     * @param params
     * @param params.id id of the project (required)
     * @param params.ref_name name of repository branch or tag or if not given the default branch (optional)
     */
     ...
     * @param params
     * @param params.id id of the project (required)
     * @param params.sha commit hash or name of a repository branch or tag (required)
     */
     ...
     * @param params
     * @param params.id id of the project (required)
     * @param params.sha name of a repository branch or tag or if not given the default branch (required)
     */
     ...
     * @param params
     * @param params.id id of the project (required)
     * @param params.path path inside repository. Used to get content of subdirectories (optional)
     * @param params.ref_name name of a repository branch or tag or if not given the default branch (optional)
     */
