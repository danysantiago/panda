...
var oldLimit = 1000*60*3; //How old a file has to be to delete it, in ms 
var delay = 1000*60*60; //How often cleaning will be done, in ms
...
module.exports = function (tmpDir, mlog) {
  ...
  fs.stat(tmpDir, function (err, stats) {
    ...
    if(!stats.isDirectory()) {
      throw Error("Given tmpDir is not a directory");
    }
